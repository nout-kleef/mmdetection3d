...
def inside_range(l, classname, diff) -> bool:
    car_range = np.array([
        [[0, 29.3], [-16.7, 16.7], [-2.75, 1.25]],
        [[0, 46.9], [-26.7, 26.7], [-2.75, 1.25]],
        [[0, 70.4], [-40.0, 40.0], [-2.75, 1.25]],
        [[-1e6, 1e6], [-1e6, 1e6], [-1e6, 1e6]],
    ])
    ped_range = np.array([
        [[0, 20], [-8.3, 8.3], [-2.25, 0.75]],
        [[0, 32], [-13.3, 13.3], [-2.25, 0.75]],
        [[0, 48], [-20.0, 20.0], [-2.25, 0.75]],
        [[-1e6, 1e6], [-1e6, 1e6], [-1e6, 1e6]],
    ])
...
def inhouse_eval_coco_style(gt_annos, dt_annos, current_classes):
    ...
    for j, curcls_name in enumerate(current_classes):
        ...
        result += print_str((f'{curcls_name} '
