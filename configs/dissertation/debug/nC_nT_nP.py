...
data_root = '/mnt/12T/nout/debug/nC_nT_nP/kitti_format/'
class_names = ['Pedestrian', 'Cyclist', 'Car', 'Truck']
point_cloud_range = [0, -39.68, -3, 69.12, 39.68, 1]
input_modality = dict(use_lidar=True, use_camera=False)
db_sampler = dict(
    data_root='/mnt/12T/nout/debug/nC_nT_nP/kitti_format/',
    info_path='/mnt/12T/nout/debug/nC_nT_nP/kitti_format/inhouse_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
train_dataset = dict(
    type='InhouseDataset',
    data_root='/mnt/12T/nout/debug/nC_nT_nP/kitti_format/',
    ann_file='/mnt/12T/nout/debug/nC_nT_nP/kitti_format/inhouse_infos_train.pkl',
    split='training',
    pts_prefix='lidar',
    pipeline=[
        dict(
...
data = dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                db_sampler=dict(
                    data_root='/mnt/12T/nout/debug/nC_nT_nP/kitti_format/',
                    info_path=
                    '/mnt/12T/nout/debug/nC_nT_nP/kitti_format/inhouse_dbinfos_train.pkl',
                    rate=1.0,
                    prepare=dict(
                        filter_by_difficulty=[-1],
                        filter_by_min_points=dict(
    ...
    val=dict(
        type='InhouseDataset',
        data_root='/mnt/12T/nout/debug/nC_nT_nP/kitti_format/',
        ann_file='/mnt/12T/nout/debug/nC_nT_nP/kitti_format/inhouse_infos_val.pkl',
        split='training',
        pts_prefix='lidar',
        pipeline=[
            dict(
