...
model = dict(
    ...
    test_cfg=dict(
        ...
        nms_pre=100,
        max_num=50))
_point_cloud_range = [0, -39.68, -3, 69.12, 39.68, 1]
...
db_sampler = dict(
    data_root='data/inhouse_filtered/kitti_format/',
    info_path='data/inhouse_filtered/kitti_format/inhouse_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
train_pipeline = [
    ...
    dict(
        ...
        db_sampler=dict(
            data_root='data/inhouse_filtered/kitti_format/',
            info_path=
            'data/inhouse_filtered/kitti_format/inhouse_dbinfos_train.pkl',
            rate=1.0,
            prepare=dict(
                filter_by_difficulty=[-1],
...
train_dataset = dict(
    type='InhouseDataset',
    data_root='data/inhouse_filtered/kitti_format/',
    ann_file='data/inhouse_filtered/kitti_format/inhouse_infos_train.pkl',
    split='training',
    pts_prefix='lidar',
    pipeline=[
        dict(
...
data = dict(
    ...
    val=dict(
        type='InhouseDataset',
        data_root='data/inhouse_filtered/kitti_format/',
        ann_file='data/inhouse_filtered/kitti_format/inhouse_infos_val.pkl',
        split='training',
        pts_prefix='lidar',
        pipeline=[
            dict(
