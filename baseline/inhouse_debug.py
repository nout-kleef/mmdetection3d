...
db_sampler = dict(
    data_root='data/inhouse/kitti_format/',
    info_path='data/inhouse/kitti_format/inhouse_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
train_dataset = dict(
    type='InhouseDataset',
    data_root='data/inhouse/kitti_format/',
    ann_file='data/inhouse/kitti_format/inhouse_infos_train.pkl',
    split='training',
    pts_prefix='lidar',
    pipeline=[
        dict(
...
data = dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                db_sampler=dict(
                    data_root='data/inhouse/kitti_format/',
                    info_path=
                    'data/inhouse/kitti_format/inhouse_dbinfos_train.pkl',
                    rate=1.0,
                    prepare=dict(
                        filter_by_difficulty=[-1],
                        filter_by_min_points=dict(
    ...
    val=dict(
        type='InhouseDataset',
        data_root='data/inhouse/kitti_format/',
        ann_file='data/inhouse/kitti_format/inhouse_infos_val.pkl',
        split='training',
        pts_prefix='lidar',
        pipeline=[
            dict(
...
work_dir = 'baseline'
load_from = None
resume_from = 'baseline/epoch_110.pth'
workflow = [('train', 1)]
gpu_ids = [0]
